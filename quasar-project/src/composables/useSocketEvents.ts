...
export function useSocketEvents(
  ...
  callbacks: {
    ...
    onChannelCreated?: (data: { id: number; title: string; availability: string; creatorId: number; createdAt: string; userId?: number }) => void
    onInviteCreated?: (data: { id: number; channelId: number; title: string; availability: string; createdAt: string; userId: number }) => void
    onChannelJoined?: (data: { channelId: number; userId: number; channel: { id: number; title: string; availability: string; creatorId: number; createdAt: string } }) => void
    onMemberJoined?: (data: { channelId: number; userId: number; userName: string; status: string }) => void
